...
router.get('/', function(req, res, next) {
    ...
    var searchChild ='SELECT adultOneFirstName AS CA1FN, adultOneLastName AS CA1LN, mainPhone AS CMP, firstName AS CFN, lastName AS CLN FROM families f, children c WHERE f.id = c.familyID AND lastName REGEXP "' + searchString + '" UNION SELECT adultOneFirstName AS CA1FN, adultOneLastName AS CA1LN, mainPhone AS CMP, firstName AS CFN, lastName AS CLN FROM families f, children c WHERE f.id = c.familyID AND firstName REGEXP "' + searchString + '" ';
