...
//this should get all the families for the mailing list
	famList: 'SELECT null AS company, adultOneCity AS city, id AS id, adultOneFirstName AS firstName, adultOneLastName AS lastName, adultOneEmail AS email FROM families UNION SELECT null AS company, adultTwoCity as city, id AS id, adultTwoFirstName AS firstName, adultTwoLastName AS lastName, adultTwoEmail email FROM families',
